      ...
      function(require, module, exports) {
        ...
        Board.prototype.getGroup = function(coord, overrideType) {
          ...
          while (queue.length) {
            ...
            if (c.toString() in seen) continue
            // seen already
        ...
        Board.prototype.playMove = function(coord, stone, ko) {
          ...
          if (ko && coord.equals(ko))
            return { success: false, errorMsg: "Cannot retake ko immediately!" }
      ...
      function(require, module, exports) {
        ...
        var Canvas = function(elem, opt, images) {
          ...
          canvas.onmousemove = function(ev) {
            ...
            if (c.i < this.opt.view.xOffset || c.i >= this.opt.view.xOffset + this.opt.view.width)
              c.i = -1

            if (c.j < this.opt.view.yOffset || c.j >= this.opt.view.yOffset + this.opt.view.height)
              c.j = -1

            if (lastMove.equals(c)) return
            // no change
