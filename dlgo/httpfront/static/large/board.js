...
JGO.BOARD.large = {
  ...
  grid: {color: '#202020', x: 50, y: 50, smooth: 0.0,borderWidth: 1.5, lineWidth: 1.2},
  ...
  mark: {lineWidth: 1.5, blackColor: 'white', whiteColor: 'black', clearColor: 'black', font: 'normal 24px sanf-serif'}
};
