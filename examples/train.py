...
def train(args):
    ...
    try:
        while True:
            ...
            print(
                "Training epoch %d chunk %d/%d..."
                % (run.epochs_completed + 1, run.chunks_completed + 1, run.num_chunks)
            )
...
def main():
    ...
    init_parser.add_argument(
        ...
        "-n",
        required=True,
        help="Python module that defines the network architecture, " 'e.g. "networks.small"',
    )
