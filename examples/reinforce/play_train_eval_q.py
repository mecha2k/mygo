...
def load_agent(filename):
    with h5py.File(filename, "r") as h5file:
        return reinforce.load_q_agent(h5file)
...
def evaluate(learning_agent, reference_agent, num_games, num_workers, board_size, temperature):
    games_per_worker = num_games // num_workers
    gpu_frac = 0.95 / float(num_workers)
...
def main():
    ...
    agent_file = WORK_DIR + "/q_agent_v1.hdf5"
    log_file = WORK_DIR + "/q_agent.log"
